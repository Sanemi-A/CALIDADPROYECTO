    ...
    if ($("#performanceLine").length) { 
      ...
      new Chart(ctx, {
          ...
          data: {
              ...
              datasets: [{
                  label: 'Este año',
                  data: [2, 1, 4, 5, 6, 1, 2, 2, 1, 4, 2, 3], // Datos por mes
                  ...
                  label: 'El año pasado',
                  data: [4, 1, 2, 3, 2, 1, 5, 3, 1, 2, 1, 3], // Datos por mes
          ...
          options: {
            ...
            scales: {
              ...
              x: {
                ...
                ticks: {
                  beginAtZero: false,
                  autoSkip: false,
                  maxTicksLimit: 12, // Asegura que se muestren todos los meses
                  color: "#6B778C",
                  font: {
                    size: 10,
                  }
            ...
            plugins: {
              legend: {
                ...
                align: 'end', // Alinea la leyenda a la derecha
              }
            }
          }
      });
